...
public class ProgramaPrincipal {
	...
	public static void main(String[] args) {
		...
		String[] escalaMal = {"DO","RE","MI","FA#","SOL","LA","SI","DO"};
		String[] partitura = {"DO","RE","DO","LA","SOL","LA","SI","DO","FA","DO","SI","DO","FA","DO","SI","DO","FA","DO"};
		//Creo objeto Piano
		...
		//Derecha Correcto
		System.out.println("Introducir melodia derecha (intento 2):");
